...
function onThumbClick(event) {
    //clear all active states for all thumbnails
    gallery.forEach( img => {
...
function setHeroImage(imageIndex) {
    heroImg.src = "./download/images/image-product-"+imageIndex+".jpg";
    gallery.forEach(img => {
       img.classList.remove('active') ;
    });
...
function addToCart() {
   ...
   const productHTMLElement =`
    <div class="item">
        <img class="product-img" src="./download/images/image-product-1-thumbnail.jpg" alt="product 1 thumbnail"> 
        <div class="details">
        ...
        <img id="btnDelete" src="./download/images/icon-delete.svg" alt="icon delete">
    </div>
   `;
...
function setOverlayHeroImage(imageIndex) {
    lightboxHero.src = "./download/images/image-product-"+imageIndex+".jpg";
    lightboxGallery.forEach(img => {
       img.classList.remove('active') ;
    });
